...
<div class="row">
  <div class="col-xs-6"><?php print $givenName; ?></div>
  <div class="col-xs-6"><?php print $familyName; ?></div>
</div>
<div class="row">
...
<div class="row">
  <div class="col-xs-3"><?php print $zip; ?></div>
  <div class="col-xs-9"><?php print $city; ?></div>
</div>
<div class="row">
