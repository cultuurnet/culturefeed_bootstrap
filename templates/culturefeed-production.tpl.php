...
<div class="row">
    ...
    <table class="table table-condended">
      <tbody>
        <?php if (!empty($performers)): ?>     
          <tr>
            <th>
              ...
              <i class="fa fa-users hidden-md hidden-lg"></i>
            </th>
            <td>
              <?php print $performers; ?>
            </td>
          </tr>
        <?php endif; ?>
        ...
        <?php if ($location && $relations < 2): ?>
          <tr>
            <th class="col-lg-2 col-md-2 col-sm-1 col-xs-1">
              <strong class="hidden-xs hidden-sm">
                <?php print t('Where'); ?>
              </strong>
        ...
        <?php if (!empty($price)): ?>
          <tr>
            <th>
              ...
              <i class="fa fa-eur hidden-md hidden-lg"></i>
            </th>
            <td>
              <?php print $price; ?>
        ...
        <?php if (!empty($reservation)): ?>
          <tr>
            <th>
              <strong class="hidden-xs hidden-sm">
                <?php print t('Reservations'); ?>
              </strong>
              <i class="fa fa-ticket hidden-md hidden-lg"></i>
            </th>
            <td>
        ...
        <?php if (!empty($contact['mail']) || !empty($contact['phone']) || !empty($contact['fax'])) : ?>
          <tr>
            <th>
              ...
              <i class="fa fa-info-circle hidden-md hidden-lg"></i>
            </th>
            <td>
        ...
        <?php if (!empty($links)): ?>
          <tr>
            <th>
              ...
              <i class="fa fa-external-link hidden-md hidden-lg"></i>
            </th>
            <td>
        ...
        <?php if (!empty($facilities)): ?>
          <tr>
            <th>
              <strong class="hidden-xs hidden-sm">
                <?php print t('Facilities'); ?>
              </strong>
              <i class="fa fa-wheelchair hidden-md hidden-lg"></i>
            </th>
            <td>
        ...
        <tr>
          <th>
            <strong class="hidden-xs hidden-sm">
              <?php print t('Program schedule'); ?>
            </strong><i class="fa fa-calendar hidden-md hidden-lg"></i>
          </th>
  ...
  <div class="col-sm-4 hidden-xs">
    ...
    <div class="hidden-xs">
      <img src="<?php print $main_picture; ?>?width=360&maxheight=400&scale=both&crop=auto" class="img-responsive" alt="<?php print $title; ?>" />
