...
<?php if ($active): ?>
  <div class="facet-label active">
    <div class="row">
      ...
      <div class="col-xs-3 text-right text-muted"><a href="<?php print $url; ?>" class="" title="<?php print t('Remove filter'); ?>"><span class="element-invisible"><?php print t('Remove filter'); ?></span>&times;</a></div>
    </div>
  </div>
<?php else: ?>
