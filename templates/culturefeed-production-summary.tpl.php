...
<div class="media">
  ...
  <div class="media-body container">
    ...
    <?php if (!empty($tickets)): ?>
      <p class="hidden-xs"><?php print culturefeed_search_detail_l('production', $cdbid, $title, '<i class="fa fa-ticket"></i> ' . t('Info & tickets'), array('html' => TRUE, 'attributes' => array('class' => array('btn', 'btn-warning')))); ?></p>
    <?php else: ?>
      <p class="hidden-xs"><?php print culturefeed_search_detail_l('production', $cdbid, $title, t('More info'), array('attributes' => array('class' => array('btn', 'btn-default')))); ?></p>
    <?php endif; ?>
